declare module "dc-bot" {
    ...
    import Command, { CommandData } from "./src/Command";
    
    import CommandConstructor from './src/Command'
    declare interface GuildInDB {
        prefix?: string,
        id?: string,
        name?: string,
        ownerID?: string,
    ...
    declare interface UserInDB {
        id?: string,
        name?: string,
        tag?: string
    }
    
    declare interface DBOptions<GDB, UDB> {
        /**
    ...
    declare interface BotOptions<GDB, UDB> {
    ...
    declare type ParamsDictionary<T> = {
        [key: string]: T
    }

    export class Command<D, GDB, UDB> extends CommandConstructor<D, GDB, UDB> {}
